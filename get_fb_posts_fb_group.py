...
app_secret = "INPUT YOUR FB APP_SECRET CODE HERE"  # DO NOT SHARE WITH ANYONE!
group_id = "1717731545171536" # UCB Meme group ID

# input date formatted as YYYY-MM-DD
since_date = variables.from_date
until_date = variables.to_date
